            ...
            <div className = "outer">
              ...
              <div className = "rightOuter">
                <TextField hintText="User ID"
                  ...
                  />
                <div>
                  <RaisedButton label="Login" secondary={true} style={newStyle}/>
                  <RaisedButton label="Sign Up" secondary={true} style={newStyle} onClick={()=>this.handleOpen()} />
                    <Dialog
